		...
		>
			...
			>
				...
				<div className="credit-pie">
					<div className="income_chart">
						<canvas ref={income_chart} width={200} height={200}></canvas>
					</div>
					<div className="balance_chart">
						<canvas ref={balance_chart} width={200} height={200}></canvas>
					</div>
					<div className="expense_chart">
						<canvas ref={expense_chart} width={200} height={200}></canvas>
					</div>
				</div>
			</motion.div>
			...
			>
				<div className="logoutcontainer">
					...
					<div className="logout-options">
						<button className="yes" onClick={() => store.logoutUser(navigate)}>
							Yes
						</button>
						<button className="no" onClick={() => setislogout(!islogout)}>
							No
						</button>
					</div>
				</div>
			...
			<div className="Profile-photo">
				<div className="profilepic">
					<img src={store.userData?.profilePicture || profilepic} alt="" />
				</div>
				<div>Vaidik</div>
			</div>
