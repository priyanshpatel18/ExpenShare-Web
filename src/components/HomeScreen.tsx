		...
		>
			<div className="userDashbord">
				...
				<div className="leftDashbord">
					<div className="welcomeText">
						<motion.div
							...
							onClick={() => setIsEditing(!isEditing)}
						>
							<img src={store.userData?.profilePicture || logo} alt="Profile Picture" />
						</motion.div>
						<div>
							<h2>Welcome,</h2>
							<div>{store.userData?.userName || "User"}</div>
						</div>
						<div className="notification" onClick={() => navigate("/notofication")}>
					...
					<motion.div className="balance">
						...
						<div className="row2 ">
							<motion.p>₹{Amounttosort(String(data_balance))}</motion.p>
						</div>
						...
						<div className="row3">
							<div className="income">
								...
								<div className="value">
									...
									<div>
										<span>₹</span>
										<motion.span>{Amounttosort(String(data_income))}</motion.span>
									</div>
								</div>
							</div>
							...
							<div className="expense">
								...
								<div className="value">
									...
									<div>
										<span>₹</span>
										<motion.span>{Amounttosort(String(data_expense))}</motion.span>
									</div>
								</div>
							</div>
						</div>
				...
				<motion.div className="rightDashbord">
					...
					>
						<button className="desktopAddExpenseBtn" onClick={() => navigate("/Addtransactions")}>
							Add Expenses
						</button>
					</motion.div>
				</motion.div>
					...
					store.transactions.map((T: TransactionType, index: React.Key | null | undefined) => (
						...
						>
							<div className="transactionDetail">
								...
								<div className="transactionDetail-text">{T.transactionTitle}</div>
							</div>
							<div
								className={`${
								...
								ref={ammount_ref}
							>
								{T.type == "expense" ? "-" : "+"} ₹{Amounttosort(T.transactionAmount)}
							</div>
						</motion.div>
					))
				)}
			...
			{selectedTransaction && (
				<div className="transaction-popup">
					<div className="transactionpopupnav">
						<img src={back} alt="" onClick={closeTransactionPopup} />
					</div>
					...
					<div className="popup-content">
						<div className="Tpopupid">
							...
							<div className="Tpopupid_value">{selectedTransaction._id}</div>
						</div>
						...
						<div className="Tpopupcategory">
							...
							<div className="Tpopupcategory_otherdetails">
								<div className="Tpopupcategory_otherdetails_title">Title</div>
						...
						<div className="Tpopupdateandtime">
							<div className="Tpopupdateandtime_title">Transaction Date</div>
							<div className="Tpopupdateandtime_values">
								<div className="Tpopupdateandtime_date">
									{formatDateTimeString(selectedTransaction.transactionDate).date}
								</div>
								<div className="Tpopupdateandtime_time">
									{formatDateTimeString(selectedTransaction.transactionDate).time}
								</div>
							</div>
						</div>
