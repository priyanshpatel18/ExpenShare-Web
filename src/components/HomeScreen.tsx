			...
			<div className="userDashbord">
				...
				<div className="leftDashbord">
					...
					<motion.div className="balance">
						...
						<div className="row2">
							<motion.p>{`${
								Math.sign(store.userData?.totalBalance ?? 0) == 1 ? "" : "-"
							}₹${Math.abs(store.userData?.totalBalance ?? 0)}`}</motion.p>
						</div>
						...
						<div className="row3">
							<div className="income">
								...
								<div className="value">
									...
									<div>
										<span>$</span>
										<motion.span>{store.userData?.totalIncome || 0}</motion.span>
									</div>
								</div>
							</div>
							...
							<div className="expense">
								...
								<div className="value">
									...
									<div>
										<span>$</span>
										<motion.span>{store.userData?.totalExpense || 0}</motion.span>
									</div>
								</div>
							</div>
						</div>
